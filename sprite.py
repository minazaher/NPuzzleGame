...
class Button:
    def __init__(self, x, y, width, height, text, colour, text_colour,font_size):
    ...
    def draw(self, screen):
        ...
        self.font_size_inf = font.size(self.text)
        draw_x = self.x + (self.width / 2) - self.font_size_inf[0] / 2
        draw_y = self.y + (self.height / 2) - self.font_size_inf[1] / 2
